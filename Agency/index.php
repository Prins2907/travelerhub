<?php
  ...
  if(isset($_REQUEST["login"]))
  {
      ...
      $sel = "Select * from agencyregister where Email_id = '$email' and Password = '$password' and Status = 'Approved'";
      ...
      if($rowcount>0)
      {
        ...
        $_SESSION["id"] = $ftch["Agy_id"];
        $_SESSION["name"] = $ftch["Agency_name"];
...
<div class="login-box">
  <div class="login-logo">
    <a href="index2.html"><b>AGENCY</b> Login</a>
  </div>
  <!-- /.login-logo -->
